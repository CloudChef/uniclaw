...
from app.uniclaw.hooks import HookDefinition, HookPhase, HookSystem
from app.uniclaw.messages.handler import ChatType, InboundMessage, MessageHandler
...
class _RecordingPromptBuilder:
    ...
    def build(self, session=None, skills=None, tools=None, md_skills=None):
        self.calls.append(
            {
                "session": session,
                "skills": skills or [],
