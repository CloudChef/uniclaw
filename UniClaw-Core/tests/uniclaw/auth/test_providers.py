...
from app.uniclaw.auth.models import AuthResult, AuthenticationError
from app.uniclaw.auth.providers.none import NoneProvider
from app.uniclaw.auth.providers.smartcmp import SmartCMPProvider
from app.uniclaw.auth.providers.api_key import APIKeyProvider
from app.uniclaw.auth.config import SmartCMPAuthConfig, APIKeyAuthConfig
...
class TestSmartCMPProvider:
    def _make_provider(self, validate_url="https://api.example.com/validate"):
        cfg = SmartCMPAuthConfig(validate_url=validate_url)
        return SmartCMPProvider(cfg)
