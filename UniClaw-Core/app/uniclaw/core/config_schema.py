...
# AuthConfig is referenced only in UniclawConfig.auth field annotation.
...
class UniclawConfig(BaseModel):
    """Uniclaw configuration"""
    log_level: LogLevel = LogLevel.INFO
    workspace_path: str = Field(default="~/.uniclaw/workspace", description="工作区路径")
    agents_dir: str = Field(default="~/.uniclaw/agents", description="智能体目录")
    ...
    auth: Optional[Any] = Field(
        default=None,
        description="认证配置，对应 uniclaw.json 的 auth 节，缺少时回退为 anonymous 模式",
    )
