# UniClaw Skill Development Guide
...
A **Skill** in UniClaw is a discrete unit of functionality that the AI Agent can execute. Skills encapsulate:
...
**Location**: `app/uniclaw/skills/built_in/`
...
**Location**: `app/uniclaw/providers/<provider>/skills/`
...
Restart UniClaw or trigger Skill reload to verify.
...
UniClaw searches for Skills in the following order:

1. **Workspace Skills** - `{workspace}/skills/`
2. **User Skills** - `~/.uniclaw/skills/`
3. **Built-in Skills** - `app/uniclaw/skills/built_in/`
4. **Provider Skills** - `app/uniclaw/providers/*/skills/`
...
```bash
tail -f logs/uniclaw.log
```

### Getting Help

Resources for Skill development:
- [UniClaw Documentation](./PROJECT_OVERVIEW.md)
- [Provider Guide](./PROVIDER_GUIDE.md)
- [Example Skills](../app/uniclaw/skills/built_in/)
- [Community Forum](https://github.com/uniclaw/uniclaw/discussions)
...
5. Restart UniClaw or trigger reload
6. Verify via API
7. Test with Agent
...
| User | `~/.uniclaw/skills/` | High |
| Built-in | `app/uniclaw/skills/built_in/` | Medium |
| Provider | `app/uniclaw/providers/*/skills/` | Low |
