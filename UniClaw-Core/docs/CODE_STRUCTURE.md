...
│   ├── uniclaw.test.json           # Test configuration
│   ├── uniclaw/                    # Python tests
│   │   ├── test_core.py
│   │   ├── test_agent.py
...
│   └── completed/
│
├── uniclaw.json                    # Main configuration
...
| File | Purpose |
|------|---------|
| `app/uniclaw/main.py` | FastAPI application entry |
...
| File | Purpose |
|------|---------|
| `uniclaw.json` | Main configuration file |
| `tests/uniclaw.test.json` | Test configuration |
| `app/uniclaw/core/config_schema.py` | Configuration schemas |

### Core Logic

| File | Purpose |
|------|---------|
| `app/uniclaw/agent/runner.py` | Agent execution engine |
| `app/uniclaw/skills/registry.py` | Skills registration |
| `app/uniclaw/session/manager.py` | Session management |
| `app/uniclaw/memory/manager.py` | Memory management |

### API

| File | Purpose |
|------|---------|
| `app/uniclaw/api/routes.py` | REST API routes |
| `app/uniclaw/api/sse.py` | SSE streaming |
| `app/uniclaw/api/websocket.py` | WebSocket handler |
...
1. Create directory: `app/uniclaw/providers/<name>/`
...
```
~/.uniclaw/agents/<agent_id>/sessions/<user_id>/
├── sessions.json
├── <session_id>.jsonl
└── archive/
```
...
```
~/.uniclaw/agents/<agent_id>/memory/
├── vector/
└── fulltext/
```
