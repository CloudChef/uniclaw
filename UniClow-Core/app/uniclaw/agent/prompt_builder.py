...
if TYPE_CHECKING:
    from app.uniclaw.auth.models import UserInfo
...
class PromptBuilder:
    ...
    Example usage:
        ...
        config = PromptBuilderConfig(
            ...
            workspace_path="~/.uniclaw/workspace",
        )
...
如需了解 Uniclaw 的行为、命令、配置或架构，请首先查阅本地文档。"""
...
inject Bootstrap
 ...
 BOOTSTRAP.md at workspace inject(.uniclaw_new_workspace).
